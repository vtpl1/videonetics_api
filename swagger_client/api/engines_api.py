...
class EnginesApi(object):
    ...
    def precis_engine_tasks_v2_jobid_post(self, if_match, jobid, **kwargs):  # noqa: E501
        """Create an precisEngineTasks  # noqa: E501

        Create a engineTasks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.precis_engine_tasks_v2_jobid_post(if_match, jobid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str if_match: (required)
        :param str jobid: Unique ID (required)
        :param PrecisEngineTask body:
        :return: DefaultResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.precis_engine_tasks_v2_jobid_post_with_http_info(if_match, jobid, **kwargs)  # noqa: E501
        else:
            (data) = self.precis_engine_tasks_v2_jobid_post_with_http_info(if_match, jobid, **kwargs)  # noqa: E501
            return data

    def precis_engine_tasks_v2_jobid_post_with_http_info(self, if_match, jobid, **kwargs):  # noqa: E501
        """Create an precisEngineTasks  # noqa: E501

        Create a engineTasks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.precis_engine_tasks_v2_jobid_post_with_http_info(if_match, jobid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['if_match', 'jobid', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method precis_engine_tasks_v2_jobid_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'if_match' is set
        if ('if_match' not in params or
                params['if_match'] is None):
            raise ValueError("Missing the required parameter `if_match` when calling `precis_engine_tasks_v2_jobid_post`")  # noqa: E501
        # verify the required parameter 'jobid' is set
        if ('jobid' not in params or
                params['jobid'] is None):
            raise ValueError("Missing the required parameter `jobid` when calling `precis_engine_tasks_v2_jobid_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/precisEngineTasksV2/{jobid}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
