...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2018-12-06T15:39:17.411Z[GMT]")public class GroupTag {
  ...
  * @return name
  **/
  @Schema(example = "group-n", description = "")
