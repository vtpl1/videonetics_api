...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(AccessStatus.class, new TypeSelector<AccessStatus>() {
            @Override
            public Class<? extends AccessStatus> getClassForElement(JsonElement readElement) {
                Map<String, Class<? extends AccessStatus>> classByDiscriminatorValue = new HashMap<>();

                    classByDiscriminatorValue.put("enterpriseDetail".toUpperCase(), EnterpriseDetail.class);
                    classByDiscriminatorValue.put("AccessStatus".toUpperCase(), AccessStatus.class);
